...
def arpCacheFlush(ipAdr):
    """
    Flush the system ARP cacahe for the ipAdr passed.

    Crude call to system command line, but place holder for more elegant solution later
    """
    from os import system
    system( "arp -d %s" % (ipAdr) )  # ensure arp cache reloaded
