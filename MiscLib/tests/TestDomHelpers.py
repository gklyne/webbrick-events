...
<root attr="attrtext">
  ...
  final text
        ...
        # LPK TODO find out how to determine the source file name at runtime.
...
def getTestSuite():
    ...
    #TODO: deprecate me
    suite.addTest(TestDomHelpers("testGetNamedNode"))
    ...
    # Dictonary to XMl tests
    suite.addTest(TestDomHelpers("testGetDictFromSimpleXml"))
    suite.addTest(TestDomHelpers("testGetDictFromXml"))
    suite.addTest(TestDomHelpers("testGetDictFromXml2"))
    suite.addTest(TestDomHelpers("testGetXmlFromDict"))
    suite.addTest(TestDomHelpers("testGetXmlFromDict2"))
