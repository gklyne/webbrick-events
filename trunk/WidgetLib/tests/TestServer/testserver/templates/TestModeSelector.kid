...
<head>
    ...
    <script type="text/javascript" src="/widgets/ModeSelector/ModeSelector.js"></script>
    <link type="text/css" href="/widgets/ModeSelector/ModeSelector.css" rel="stylesheet" />
</head>
