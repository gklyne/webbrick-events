...
webbrick.namespace("webbrick.SimpleTest");
...
SimpleTest.showReport = function() {
    var togglePassed = MochiKit.DOM.A({'href': '#'}, "Toggle passed tests");
    var toggleFailed = MochiKit.DOM.A({'href': '#'}, "Toggle failed tests");
    togglePassed.onclick = MochiKit.Base.partial(SimpleTest.toggleByClass, 'test_ok');
    toggleFailed.onclick = MochiKit.Base.partial(SimpleTest.toggleByClass, 'test_not_ok');
    ...
    addNode(MochiKit.DOM.SPAN(null, " "));
