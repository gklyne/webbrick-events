...
var absolutizeTestCases = [
    ...
    // from Dan Connolly's tests in http://www.w3.org/2000/10/swap/uripath.py
    ...
    // 01-31 are from Connolly's cases
    //
    // 32-49
    ["./q:r", "http://ex/x/y", "http://ex/x/q:r"],
